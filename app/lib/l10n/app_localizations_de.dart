...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get playgroundRulesPatterns5 =>
      'Fünfundzwanzig Pappquadrate sind mit Linien bezeichnet. Setze sie zu einem 5 × 5-Quadrat zusammen, sodass sich die Abschnitte zu einer einzigen geschlossenen Linie schließen, die sich nirgends selbst kreuzt. Die Linie verläuft durch jedes Quadrat, schiefgehen kann also nur ein Übergang: Ein Linienende stößt auf einen leeren Rand des Nachbarn, ein Linienende zeigt aus dem Quadrat heraus, oder die Abschnitte schließen sich zu mehreren einzelnen Schleifen statt zu einer. Die Quadrate lassen sich um eine Vierteldrehung drehen, aber nicht umdrehen - die Pappe ist einseitig. Tippe auf ein Quadrat im Vorrat, um es zu wählen; tippe erneut, dann dreht es sich; tippe danach auf einen freien Platz im Quadrat. Ein bereits gelegtes Quadrat kann an Ort und Stelle gedreht oder in den Vorrat zurückgelegt werden. Die Zahl der Züge spielt hier keine Rolle - nur das fertige Muster zählt. Eine vollständige Suche zeigt, dass es genau 2048 solcher Muster gibt, Drehungen des ganzen Quadrats mitgezählt.';

  @override
  String get playgroundRulesPatterns4 =>
      'Dieselben Linien, aber nur noch sechzehn Quadrate - genau die sechzehn der fünfundzwanzig, die auch die Lösung im Buch verwendet. Setze sie zu einem 4 × 4-Quadrat zusammen, sodass sich die Abschnitte zu einer einzigen geschlossenen Linie schließen, die sich nirgends selbst kreuzt. Die Linie verläuft durch jedes Quadrat, schiefgehen kann also nur ein Übergang: Ein Linienende stößt auf einen leeren Rand des Nachbarn, ein Linienende zeigt aus dem Quadrat heraus, oder die Abschnitte schließen sich zu mehreren einzelnen Schleifen statt zu einer. Die Quadrate lassen sich um eine Vierteldrehung drehen, aber nicht umdrehen - die Pappe ist einseitig. Tippe auf ein Quadrat im Vorrat, um es zu wählen; tippe erneut, dann dreht es sich; tippe danach auf einen freien Platz im Quadrat. Ein bereits gelegtes Quadrat kann an Ort und Stelle gedreht oder in den Vorrat zurückgelegt werden. Die Zahl der Züge spielt hier keine Rolle - nur das fertige Muster zählt. Eine vollständige Suche zeigt, dass es genau 512 solcher Muster gibt, Drehungen des ganzen Quadrats mitgezählt.';
