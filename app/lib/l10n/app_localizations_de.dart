...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get playgroundRulesSwapBlocks =>
      'Ein rechteckiger Kasten von 16 mal 8 Feldern enthält zwölf identische P-förmige Blöcke. Jeder Block bedeckt acht Zellen, also sind 96 der 128 Zellen belegt und 32 bleiben frei — vier leere Reihen quer durch die Mitte. Zwei rote Blöcke oben bilden ein Quadrat, zwei blaue Blöcke unten ein weiteres. Pro Zug bewegt sich ein einziger Block: Er gleitet durch den freien Raum waagerecht und senkrecht, beliebig weit, und darf dabei um Ecken biegen — die ganze Reise zählt als ein Zug. Blöcke werden nie gedreht und nie gewendet, selbst wenn der freie Raum es zulassen würde. Ziel ist, dass das rote und das blaue Quadrat die Plätze tauschen und jeder andere Block wieder an seinem Ausgangsplatz landet. Tippe einen Block an, um ihn auszuwählen; Punkte markieren jeden Ort, den er erreichen kann; halte einen Punkt gedrückt, um einen Schattenumriss des Zielplatzes zu sehen, und lass los, um den Block dorthin zu bewegen. Unzulässige Ziele werden schlicht nicht markiert. Das Buch nennt keine Lösung für dieses Rätsel. Das durch vollständige Suche bewiesene Minimum sind 32 Züge.';
