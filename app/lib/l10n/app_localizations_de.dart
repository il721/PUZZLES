...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get helpRulesPlayground =>
      'Dieser Abschnitt ist keine Variante eines einzigen Rätsels, sondern sieben eigenständige kleine Spiele: Jedes hat sein eigenes Spielfeld und eigene Regeln, die über die Schaltfläche ℹ auf seinem Bildschirm angezeigt werden. Ein Rätsel gilt als gelöst, sobald die Zielstellung erreicht ist. Bei den Rätseln, bei denen es auf Zugökonomie ankommt, merkt sich die App außerdem Ihre beste Zugzahl und kennzeichnet sie, wenn sie dem bewiesenen Minimum entspricht. Noch nicht verfügbare Spiele werden ausgegraut dargestellt. Bisher sind nur die ersten sechs freigeschaltet – „Acht Chips“, „Katzen und Hunde“, „Sanduhr“, „Überall drei“, „Muster 5 × 5“ und „Muster 4 × 4“: Bei „Acht Chips“ stehen die Chips 1–8 an den Spitzen eines achtzackigen Sterns, sie dürfen nur entlang gerader Linien bewegt werden (durch die freie Mitte kann ein Chip weiterrutschen), und das Ziel ist, sie in umgekehrter Reihenfolge aufzustellen; das bewiesene Minimum sind 28 Züge. Bei „Katzen und Hunde“ tauschen drei Katzen und drei Hunde die Seiten eines Parks: Pro Zug läuft ein Tier auf einen benachbarten freien Platz, und Katze und Hund dürfen nie nebeneinander stehen; das bewiesene Minimum sind 32 Züge. Bei „Sanduhr“ müssen fünfzehn Steine aus dem oberen Dreieck in das untere gebracht werden: Pro Zug rückt ein Stein auf einen benachbarten freien Kreis oder springt wie beim Damespiel über einen benachbarten Stein, wobei mehrere Sprünge nacheinander mit demselben Stein als ein Zug zählen; das bewiesene Minimum sind 26 Züge. Bei „Überall drei“ müssen neun 3×3-Quadrate mit roten, weißen und schwarzen Kreisen zu einem 9×9-Quadrat zusammengesetzt werden, sodass in jeder Zeile, jeder Spalte und auf beiden Diagonalen genau ein Kreis jeder Farbe liegt; die Quadrate lassen sich drehen, aber nicht wenden, und die Anzahl der Züge spielt dabei keine Rolle. Bei „Muster 5 × 5“ müssen fünfundzwanzig mit roten Linien bezeichnete Quadrate zu einem 5 × 5-Quadrat gelegt werden, sodass sich alle Abschnitte zu einer einzigen geschlossenen, sich nirgends selbst kreuzenden Linie schließen; die Quadrate lassen sich drehen, aber nicht wenden, und die Anzahl der Züge spielt auch hier keine Rolle. Bei „Muster 4 × 4“ entsteht dieselbe geschlossene Linie aus nur sechzehn Quadraten – genau denen, die auch die Lösung im Buch verwendet. Jetzt sind alle sieben freigeschaltet: Bei „Tausche die Quadrate“ füllen zwölf identische P-förmige Blöcke einen Kasten; pro Zug gleitet ein Block durch den freien Raum und darf dabei um Ecken biegen, wird aber nie gedreht; Ziel ist, dass das rote und das schwarze Quadrat die Plätze tauschen, während alle anderen Blöcke an ihren Ausgangsplatz zurückkehren; das bewiesene Minimum sind 32 Züge.';
  ...
  String get playgroundRulesThreeEach =>
      'Neun Pappquadrate im Format 3×3 sind mit roten, weißen und schwarzen Kreisen bedruckt. Setze sie zu einem 9×9-Quadrat zusammen, sodass in jeder der neun Zeilen, jeder der neun Spalten und auf beiden großen Diagonalen genau ein Kreis jeder Farbe steht. Leere Felder zählen nicht mit: Insgesamt gibt es 27 Kreise, also genau drei pro Linie. Die Quadrate lassen sich um eine Vierteldrehung drehen, aber nicht wenden — die Pappe ist einseitig bedruckt. Tippe ein Quadrat im Vorrat an, um es auszuwählen; tippe erneut, um es zu drehen; tippe dann auf einen freien Platz im großen Quadrat. Ein schon gelegtes Quadrat lässt sich an Ort und Stelle drehen oder in den Vorrat zurücklegen. Die Anzahl der Züge spielt hier keine Rolle — wichtig ist nur das fertige Quadrat. Vollständige Suche zeigt: Es gibt genau sechzehn solcher Quadrate, Drehungen des gesamten Quadrats mitgezählt.';

  @override
  String get playgroundRulesPatterns5 =>
      'Fünfundzwanzig Pappquadrate sind mit roten Linien bezeichnet. Setze sie zu einem 5 × 5-Quadrat zusammen, sodass sich die roten Abschnitte zu einer einzigen geschlossenen Linie schließen, die sich nirgends selbst kreuzt. Die Linie verläuft durch jedes Quadrat, schiefgehen kann also nur ein Übergang: Ein rotes Ende stößt auf einen leeren Rand des Nachbarn, ein rotes Ende zeigt aus dem Quadrat heraus, oder die Abschnitte schließen sich zu mehreren einzelnen Schleifen statt zu einer. Die Quadrate lassen sich um eine Vierteldrehung drehen, aber nicht umdrehen - die Pappe ist einseitig. Tippe auf ein Quadrat im Vorrat, um es zu wählen; tippe erneut, dann dreht es sich; tippe danach auf einen freien Platz im Quadrat. Ein bereits gelegtes Quadrat kann an Ort und Stelle gedreht oder in den Vorrat zurückgelegt werden. Die Zahl der Züge spielt hier keine Rolle - nur das fertige Muster zählt. Eine vollständige Suche zeigt, dass es genau 2048 solcher Muster gibt, Drehungen des ganzen Quadrats mitgezählt.';

  @override
  String get playgroundRulesPatterns4 =>
      'Dieselben roten Linien, aber nur noch sechzehn Quadrate - genau die sechzehn der fünfundzwanzig, die auch die Lösung im Buch verwendet. Setze sie zu einem 4 × 4-Quadrat zusammen, sodass sich die roten Abschnitte zu einer einzigen geschlossenen Linie schließen, die sich nirgends selbst kreuzt. Die Linie verläuft durch jedes Quadrat, schiefgehen kann also nur ein Übergang: Ein rotes Ende stößt auf einen leeren Rand des Nachbarn, ein rotes Ende zeigt aus dem Quadrat heraus, oder die Abschnitte schließen sich zu mehreren einzelnen Schleifen statt zu einer. Die Quadrate lassen sich um eine Vierteldrehung drehen, aber nicht umdrehen - die Pappe ist einseitig. Tippe auf ein Quadrat im Vorrat, um es zu wählen; tippe erneut, dann dreht es sich; tippe danach auf einen freien Platz im Quadrat. Ein bereits gelegtes Quadrat kann an Ort und Stelle gedreht oder in den Vorrat zurückgelegt werden. Die Zahl der Züge spielt hier keine Rolle - nur das fertige Muster zählt. Eine vollständige Suche zeigt, dass es genau 512 solcher Muster gibt, Drehungen des ganzen Quadrats mitgezählt.';

  @override
  String get playgroundRulesSwapBlocks =>
      'Ein rechteckiger Kasten von 16 mal 8 Feldern enthält zwölf identische P-förmige Blöcke. Jeder Block bedeckt acht Zellen, also sind 96 der 128 Zellen belegt und 32 bleiben frei — vier leere Reihen quer durch die Mitte. Zwei rote Blöcke oben bilden ein Quadrat, zwei schwarze Blöcke unten ein weiteres. Pro Zug bewegt sich ein einziger Block: Er gleitet durch den freien Raum waagerecht und senkrecht, beliebig weit, und darf dabei um Ecken biegen — die ganze Reise zählt als ein Zug. Blöcke werden nie gedreht und nie gewendet, selbst wenn der freie Raum es zulassen würde. Ziel ist, dass das rote und das schwarze Quadrat die Plätze tauschen und jeder andere Block wieder an seinem Ausgangsplatz landet. Tippe einen Block an, um ihn auszuwählen; Punkte markieren jeden Ort, den er erreichen kann; halte einen Punkt gedrückt, um einen Schattenumriss des Zielplatzes zu sehen, und lass los, um den Block dorthin zu bewegen. Unzulässige Ziele werden schlicht nicht markiert. Das Buch nennt keine Lösung für dieses Rätsel. Das durch vollständige Suche bewiesene Minimum sind 32 Züge.';
