...
class DominoPuzzleListScreen extends ConsumerWidget {
  /// Creates the puzzle list screen.
  const DominoPuzzleListScreen({super.key});
              ...
              return _PuzzleTile(
                ...
                onTap: () async {
                  await Navigator.of(context).push(
                    MaterialPageRoute<void>(builder: (_) => DominoPuzzleScreen(puzzleId: puzzle.id)),
                  );
