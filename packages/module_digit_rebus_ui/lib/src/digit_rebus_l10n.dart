...
/// Localized strings needed by the digit-rebus module's widgets.
///
...
/// its own generated localizations, via an override of
/// [digitRebusL10nProvider].
abstract class DigitRebusL10n {
...
/// Supplies the [DigitRebusL10n] implementation for the current app locale.
/// Must be overridden by the app shell (typically in a nested
/// `ProviderScope` that has access to `BuildContext`-based localizations)
/// before any module_digit_rebus_ui widget is built.
final Provider<DigitRebusL10n> digitRebusL10nProvider = Provider<DigitRebusL10n>((ref) {
  throw UnimplementedError(
    'digitRebusL10nProvider must be overridden with a concrete DigitRebusL10n before use.',
  );
});
