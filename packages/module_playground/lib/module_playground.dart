...
/// slide-a-token-along-a-line family; the two shipped games
/// ("Восемь фишек" / eight chips and "Кошки и собаки" / cats and dogs);
/// puzzle-data parsing; and the module's game registry. Flutter UI is added
